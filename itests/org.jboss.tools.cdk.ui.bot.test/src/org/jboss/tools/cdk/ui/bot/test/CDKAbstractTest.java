...
public abstract class CDKAbstractTest {
	...
	public static final String SERVER_ADAPTER_CRC = "CodeReady Containers 1.0 (Tech Preview)";
	public static final String SERVER_ADAPTER_CRC_RD = "CodeReady Containers 1.0";
