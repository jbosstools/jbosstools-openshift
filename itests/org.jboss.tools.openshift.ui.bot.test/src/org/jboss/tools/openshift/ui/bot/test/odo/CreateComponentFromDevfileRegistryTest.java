...
@CleanODOConnection
@RequiredODOProject(name="test-project17")
public class CreateComponentFromDevfileRegistryTest extends AbstractODOTest {

	private static final String ECLIPSE_PROJECT = "myproject";
	private static final String DEFAULT_DEVFILE_REGISTRY = "DefaultDevfileRegistry";
	...
	public static Collection<Object[]> data() {
		return Arrays.asList(new Object[][] {
			{"mycomp", "Maven Java", "springbootproject"},
			{"mycomp", "Go Runtime", "go-starter"},
		});
	} 
	...
	public void testCreateComponent() {
		createComponentFromRegistry(ECLIPSE_PROJECT, DEFAULT_DEVFILE_REGISTRY, componentType, starter, componentName);
