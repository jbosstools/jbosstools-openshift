...
public class OpenShiftLabel {
	...
	public static class Others {
		...
		public static final String EAP_TEMPLATE = "eap71-basic-s2i (eap, javaee, java, jboss) - openshift";
		public static final String EAP_TEMPLATE_OLD = "eap70-basic-s2i (eap, javaee, java, jboss) - openshift";
