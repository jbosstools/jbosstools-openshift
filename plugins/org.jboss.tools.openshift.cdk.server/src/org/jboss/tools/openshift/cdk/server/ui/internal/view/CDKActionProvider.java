...
public class CDKActionProvider extends CommonActionProvider {
    ...
    private static class ShowInOpenshiftViewAfterStartupAction extends ShowInViewAfterStartupAction {
        ...
        protected Object adaptToViewItem(IServer server) {
            ControllableServerBehavior beh = (ControllableServerBehavior)server.loadAdapter(ControllableServerBehavior.class,
            ...
            if (adb != null) {
                return OpenshiftUIModel.getInstance()
                        .getConnectionWrapperForConnection(new CDKOpenshiftUtility().findExistingOpenshiftConnection(server, adb));
            }
            return null;
        }
    }
