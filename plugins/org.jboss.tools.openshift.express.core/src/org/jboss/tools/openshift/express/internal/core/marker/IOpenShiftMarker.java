...
public interface IOpenShiftMarker {
    ...
    public static final IOpenShiftMarker DISABLE_AUTO_SCALING = new BaseOpenShiftMarker("disable_auto_scaling", "Disable Auto Scaling",
    ...
    public static final IOpenShiftMarker FORCE_CLEAN_BUILD = new BaseOpenShiftMarker("force_clean_build", "Force Clean Build",
            "Will start the build process by removing all non " + "essential Maven dependencies.  Any current dependencies specified in "
