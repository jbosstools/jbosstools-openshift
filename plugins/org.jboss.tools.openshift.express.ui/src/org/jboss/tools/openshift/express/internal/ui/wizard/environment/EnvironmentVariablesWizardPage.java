...
public class EnvironmentVariablesWizardPage extends AbstractOpenShiftWizardPage {
    ...
    protected void doCreateControls(Composite container, DataBindingContext dbc) {
        ...
        ValueBindingBuilder.bind(ViewerProperties.singleSelection().observe(viewer))
                .to(BeanProperties.value(AbstractEnvironmentVariablesWizardModel.PROPERTY_SELECTED).observe(model)).in(dbc);
                ...
                .validatingAfterGet(new IValidator() {
                    ...
                    public IStatus validate(Object value) {
                        if (Boolean.FALSE.equals((Boolean)value)) {
                            return ValidationStatus.warning(NLS.bind(ExpressUIMessages.ServerDoesNotSupportChanging, model.getHost()));
                        }
    ...
    private SelectionListener onRemove() {
        return new SelectionAdapter() {
            ...
            public void widgetSelected(SelectionEvent e) {
                ...
                if (MessageDialog.openConfirm(getShell(), ExpressUIMessages.RemoveVariable, NLS
                        .bind(ExpressUIMessages.DoYouWantToRemoveVariable, selectedVariable.getName() + "=" + selectedVariable.getValue())))
