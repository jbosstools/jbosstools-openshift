...
public class AddSSHKeyWizardPage extends AbstractOpenShiftWizardPage {
    ...
    protected void doCreateControls(Composite parent, DataBindingContext dbc) {
        ...
        Binding nameBinding = ValueBindingBuilder.bind(WidgetProperties.text(SWT.Modify).observe(nameText))
                ...
                .to(BeanProperties.value(AddSSHKeyWizardPageModel.PROPERTY_NAME).observe(pageModel)).notUpdatingParticipant().in(dbc);
        ...
        ControlDecorationSupport.create(sshPublicKeyValidator, SWT.LEFT | SWT.TOP, null, new RequiredControlDecorationUpdater());
