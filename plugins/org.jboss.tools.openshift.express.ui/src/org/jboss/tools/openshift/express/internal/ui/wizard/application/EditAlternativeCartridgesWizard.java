...
public class EditAlternativeCartridgesWizard extends AbstractOpenShiftWizard<EmbeddedCartridgesWizardModel> {
    ...
    public EditAlternativeCartridgesWizard(ICartridge selectedAlternative, List<ICartridge> alternativeCartridges,
        ...
        super("Add Embedded Cartridges", new EmbeddedCartridgesWizardModel(Collections.<ICartridge>singleton(selectedAlternative),
                alternativeCartridges, new NewApplicationProperties(wizardModel), wizardModel.getDomain(), wizardModel.getConnection()));
    }
