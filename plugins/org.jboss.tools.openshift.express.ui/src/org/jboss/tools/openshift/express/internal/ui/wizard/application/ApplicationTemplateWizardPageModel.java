...
public class ApplicationTemplateWizardPageModel extends ObservableUIPojo {
    ...
    private void setupWizardModelListeners(OpenShiftApplicationWizardModel wizardModel) {
        ...
        wizardModel.addPropertyChangeListener(IOpenShiftApplicationWizardModel.PROP_DOMAIN, new PropertyChangeListener() {
    ...
    protected void doSetExistingApplicationName(String name) {
        firePropertyChange(PROPERTY_EXISTING_APPLICATION_NAME, this.existingApplicationName, this.existingApplicationName = name);
    }
    ...
    public void setExistingApplications(List<IApplication> applications) throws OpenShiftException {
        firePropertyChange(PROPERTY_EXISTING_APPLICATIONS, this.existingApplications, this.existingApplications = applications);
    }
