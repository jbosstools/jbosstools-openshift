...
public class ConnectionPropertySource implements IPropertySource {
    ...
    public IPropertyDescriptor[] getPropertyDescriptors() {
        return new IPropertyDescriptor[] { new PropertyDescriptor(PROPERTY_DOMAINS, PROPERTY_DOMAINS),
                new PropertyDescriptor(PROPERTY_USERNAME, PROPERTY_USERNAME), new PropertyDescriptor(PROPERTY_HOST, PROPERTY_HOST),
    ...
    private void loadRemoteDetails(final ExpressConnection connection) throws OpenShiftException {
        ...
        try {
            ...
            if (cause instanceof OpenShiftException) {
                ...
                new OpenShiftException(cause, "Could not load details for user {0} on {1}", connection.getUsername(), connection.getHost());
            }
