...
public class ImportExpressApplicationWizard extends ExpressApplicationWizard {
    ...
    public ImportExpressApplicationWizard(IApplication application) {
        super(ExpressConnectionUtils.getByResource(application, ConnectionsRegistrySingleton.getInstance()), application.getDomain(),
                application, null, true, "Import OpenShift Application");
    }
