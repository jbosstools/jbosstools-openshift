...
public class NewSSHKeyWizardPage extends AbstractOpenShiftWizardPage {
    ...
    protected void doCreateControls(Composite parent, DataBindingContext dbc) {
        ...
        Binding nameBinding = ValueBindingBuilder.bind(WidgetProperties.text(SWT.Modify).observe(nameText))
                ...
                .to(BeanProperties.value(NewSSHKeyWizardPageModel.PROPERTY_NAME).observe(pageModel)).notUpdatingParticipant().in(dbc);
        ...
        ControlDecorationSupport.create(ssh2HomeBinding, SWT.LEFT | SWT.TOP, null, new RequiredControlDecorationUpdater());
        ...
        Binding privateKeyBinding = ValueBindingBuilder.bind(WidgetProperties.text(SWT.Modify).observe(privateKeyText))
                ...
                .to(BeanProperties.value(NewSSHKeyWizardPageModel.PROPERTY_PRIVATEKEY_FILENAME).observe(pageModel)).in(dbc);
        ControlDecorationSupport.create(privateKeyBinding, SWT.LEFT | SWT.TOP, null, new RequiredControlDecorationUpdater());
        ...
        ValueBindingBuilder.bind(passphraseObservable)
                .to(BeanProperties.value(NewSSHKeyWizardPageModel.PROPERTY_PRIVATEKEY_PASSPHRASE).observe(pageModel)).in(dbc);
        ...
        GridDataFactory.fillDefaults().align(SWT.FILL, SWT.CENTER).grab(true, false).span(3, 1).applyTo(passphraseConfirmText);
        ISWTObservableValue passphraseConfirmObservable = WidgetProperties.text(SWT.Modify).observe(passphraseConfirmText);
        ValueBindingBuilder.bind(passphraseConfirmObservable)
                .to(BeanProperties.value(NewSSHKeyWizardPageModel.PROPERTY_PRIVATEKEY_CONFIRM_PASSPHRASE).observe(pageModel)).in(dbc);
        ...
        Binding publicKeyBinding = ValueBindingBuilder.bind(WidgetProperties.text(SWT.Modify).observe(publicKeyText))
                ...
                .to(BeanProperties.value(NewSSHKeyWizardPageModel.PROPERTY_PUBLICKEY_FILENAME).observe(pageModel)).in(dbc);
        ControlDecorationSupport.create(publicKeyBinding, SWT.LEFT | SWT.TOP, null, new RequiredControlDecorationUpdater());
