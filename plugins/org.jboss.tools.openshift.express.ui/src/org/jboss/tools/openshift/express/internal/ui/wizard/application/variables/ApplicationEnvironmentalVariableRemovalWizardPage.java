 ...
 *
 */
public class ApplicationEnvironmentalVariableRemovalWizardPage extends AbstractOpenShiftWizardPage {
	 ...
	 * @param wizard
	 */
	public ApplicationEnvironmentalVariableRemovalWizardPage(String title, String description, String pageName,
			IWizard wizard) {
