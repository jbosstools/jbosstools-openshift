 ...
 *
 */
public class ApplicationEnvironmentalVariableImportWizardPage extends AbstractOpenShiftWizardPage {
	 ...
	 * @param wizard
	 */
	public ApplicationEnvironmentalVariableImportWizardPage(String title, String description, String pageName,
			IWizard wizard) {
