...
public class ApplicationConfigurationWizardPage extends AbstractOpenShiftWizardPage {
	...
	private class ApplicationToSelectNameValidator extends MultiValidator {
	...
	private class NewApplicationNameValidator extends MultiValidator {
	 ...
	 * 
	 */
	private class NewApplicationTypeValidator extends MultiValidator {
	...
	private static class SourceCodeUrlValidator extends MultiValidator {
	...
	protected SelectionListener onManageDomains() {
		return new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (new OkButtonWizardDialog(getShell(), domainWizard).open() == Window.OK) {
	...
	private void createApplicationConfigurationGroup(Composite parent, DataBindingContext dbc) {
		...
		final NewApplicationNameValidator newApplicationNameValidator =
				new NewApplicationNameValidator(useExistingAppBtnSelection, existingApplicationsLoaded,
	...
	private IValueChangeListener onDomainChanged(final DataBindingContext dbc) {
		return new IValueChangeListener() {
			...
			public void handleValueChange(ValueChangeEvent event) {
				...
				AbstractDelegatingMonitorJob job = new AbstractDelegatingMonitorJob(NLS.bind(
						"Loading applications for domain {0}...", domain.getId())) {
