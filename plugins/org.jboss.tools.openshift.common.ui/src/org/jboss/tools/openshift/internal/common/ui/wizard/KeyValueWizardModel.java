...
public class KeyValueWizardModel<T extends IKeyValueItem> extends ObservableUIPojo implements IKeyValueWizardModel<T> {
    ...
    public KeyValueWizardModel(String windowTitle, String title, String keyLabel, String valueLabel, String description, String groupLabel,
            IValidator keyAfterConvertValidator, IValidator valueAfterConvertValidator, boolean keyEditable) {
