...
public class HttpsPrefixingAdapter {
    ...
    private static final Collection CHARACTERS = Arrays.asList(SWT.CR, SWT.TAB, SWT.DEL, SWT.BS, SWT.ALT, SWT.CTRL, SWT.SHIFT, SWT.ESC,
            SWT.HOME, SWT.END, SWT.PAGE_DOWN, SWT.PAGE_UP, SWT.INSERT, SWT.CURSOR_ARROW);
    ...
    protected abstract class SchemePrefixingKeyAdapter extends KeyAdapter {
        ...
        public void keyReleased(KeyEvent e) {
            ...
            if (matchesAllOrSubstring(serverUrlBeginning, HTTP_SCHEME) || matchesAllOrSubstring(serverUrlBeginning, HTTPS_SCHEME)) {
                return;
            }
