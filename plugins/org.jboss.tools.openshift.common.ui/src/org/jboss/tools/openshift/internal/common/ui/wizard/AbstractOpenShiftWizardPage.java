...
public abstract class AbstractOpenShiftWizardPage extends WizardPage {
    ...
    protected void setupWizardPageSupport(DataBindingContext dbc) {
        ParametrizableWizardPageSupport.create(IStatus.ERROR | IStatus.INFO | IStatus.WARNING | IStatus.CANCEL, this, dbc);
    }
        ...
        return new IPageChangingListener() {
            ...
            public void handlePageChanging(PageChangingEvent event) {
                if (isChangingToThisPage(event)) {
                    if (event.getCurrentPage() == null || equals((IWizardPage)event.getCurrentPage(), getPreviousPage())) {
                    ...
                    if (event.getTargetPage() != null && equals((IWizardPage)event.getTargetPage(), getPreviousPage())) {
