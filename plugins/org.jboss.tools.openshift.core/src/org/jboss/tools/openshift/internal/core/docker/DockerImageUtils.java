            ...
            try {
                ...
                if (ResourceUtils.isSuccessful(streamImport)) {
                    ...
                    if (StringUtils.isBlank(json)) {
                        OpenShiftCoreActivator.logError("Did not find metadata during ImportImageStream for " + imageURI.getAbsoluteUri(),
                                null);
                        return null;
                    }
                ...
                OpenShiftCoreActivator.logError(NLS.bind("Could not retrieve metadata for docker image {0}", imageURI), e);
            }
        }
        return null;
    }
