...
public class RSync {
    ...
    private void syncPodToDirectory(IPod pod, String podPath, File destination, final IServerConsoleWriter consoleWriter)
            throws IOException {
        destination.mkdirs();
    ...
    private void syncDirectoryToPod(final IPod pod, final File source, final String podPath, final IServerConsoleWriter consoleWriter)
            throws IOException {
