...
public class CommandLocationLookupStrategy {
    ...
    public static final CommandLocationLookupStrategy WINDOWS_STRATEGY = new CommandLocationLookupStrategy(WINDOWS_WHERE, WIN_SEPARATOR,
            // Windows can use either separator or path variable
            // based on whether eclipse was launched from cygwin or not
            System.getenv().get(WINDOWS_PATHVAR) == null ? LINUX_PATHVAR : WINDOWS_PATHVAR, new String[] { ".exe", ".com" }, null);
    public static final CommandLocationLookupStrategy LINUX_STRATEGY = new CommandLocationLookupStrategy(LINUX_WHICH, LINUX_SEPARATOR,
            LINUX_PATHVAR, new String[] {}, null);
    public static final CommandLocationLookupStrategy MAC_STRATEGY = new CommandLocationLookupStrategy(LINUX_WHICH, LINUX_SEPARATOR,
            LINUX_PATHVAR, new String[] {}, new String[] { "bash", "-l", "-c", "echo $PATH" }, true);
