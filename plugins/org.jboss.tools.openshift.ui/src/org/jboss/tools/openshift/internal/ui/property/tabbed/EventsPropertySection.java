...
public class EventsPropertySection extends OpenShiftResourcePropertySection {
    ...
    protected void addColumns(TableViewerBuilder tableViewerBuilder) {
        ...
        tableViewerBuilder
                ...
                .minWidth(15).cellToolTipProvider(toolTipProvider).buildColumn()
                //kind
                .column(model -> ((IEvent)getResource(model)).getInvolvedObject().getKind()).name("Kind").align(SWT.LEFT).weight(1)
                ...
                .cellToolTipProvider(toolTipProvider).buildColumn();
    }
