...
public class PodPropertySource extends ResourcePropertySource<IPod> {
    ...
    public IPropertyDescriptor[] getResourcePropertyDescriptors() {
        return new IPropertyDescriptor[] { new UneditablePropertyDescriptor("ip", "IP"), new UneditablePropertyDescriptor("host", "Host"),
                new UneditablePropertyDescriptor("images", "Image(s)"), new UneditablePropertyDescriptor("status", "Status"), };
    }
