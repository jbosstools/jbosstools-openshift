...
public class ApplicationSourceDetailViews extends AbstractStackedDetailViews {
    ...
    private class ApplicationSourceDetailView extends EmptyView {
        ...
        public Composite createControls(Composite parent, Object context, DataBindingContext dbc) {
            ...
            GridDataFactory.fillDefaults().grab(false, true).span(1, 3).align(SWT.LEFT, SWT.TOP).applyTo(classIcon);
            ...
            GridDataFactory.fillDefaults().align(SWT.FILL, SWT.FILL).grab(true, true).span(3, 1).applyTo(txtDescription);
