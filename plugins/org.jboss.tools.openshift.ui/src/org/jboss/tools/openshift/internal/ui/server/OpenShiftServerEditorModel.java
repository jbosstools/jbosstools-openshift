...
public class OpenShiftServerEditorModel extends ServerSettingsWizardPageModel {
    ...
    private void update(boolean overrideProject, Connection connection, List<Connection> connections,
            org.eclipse.core.resources.IProject deployProject, List<org.eclipse.core.resources.IProject> projects, String sourcePath,
            String podPath, boolean isUseInferredPodPath, IResource resource, List<ObservableTreeItem> resourceItems, IRoute route,
            boolean isSelectDefaultRoute, Map<IProject, List<IRoute>> routesByProject, boolean useImageDevmodeKey, String devmodeKey,
            boolean useImageDebugPortKey, String debugPortKey, String debugPortValue) {
        update(connection, connections, deployProject, projects, sourcePath, podPath, isUseInferredPodPath, resource, resourceItems, route,
                isSelectDefaultRoute, routesByProject, getOCBinaryStatus(), useImageDevmodeKey, devmodeKey, useImageDebugPortKey,
                debugPortKey, debugPortValue);
    ...
    public void setOverrideProject(boolean overrideProject) {
        update(overrideProject, getConnection(), getConnections(), getDeployProject(), getProjects(), getSourcePath(), getPodPath(),
                isUseInferredPodPath(), getResource(), getResourceItems(), getRoute(), isSelectDefaultRoute(), getAllRoutes(),
                isUseImageDevmodeKey(), getDevmodeKey(), isUseImageDebugPortKey(), getDebugPortKey(), getDebugPortValue());
    }
    ...
    public class SetRouteCommand extends ServerWorkingCopyPropertyCommand {
        ...
        public SetRouteCommand(IServerWorkingCopy server, IRoute oldRoute, IRoute newRoute, String newRouteURL, String oldHost,
                String newHost) {
    ...
    private class SetResourceCommand extends ServerWorkingCopyPropertyCommand {
        ...
        public SetResourceCommand(IServerWorkingCopy server, IResource oldResource, IResource newResource) {
            super(server, "Set Resource...", null, OpenShiftResourceUniqueId.get(newResource), OpenShiftServerUtils.ATTR_SERVICE, null);
    ...
    public class SetDeployProjectCommand extends ServerWorkingCopyPropertyCommand {
        ...
        public SetDeployProjectCommand(IServerWorkingCopy server, org.eclipse.core.resources.IProject oldProj,
            ...
            super(server, "Set Project...", null, ProjectUtils.getName(deployProject), OpenShiftServerUtils.ATTR_DEPLOYPROJECT, null);
