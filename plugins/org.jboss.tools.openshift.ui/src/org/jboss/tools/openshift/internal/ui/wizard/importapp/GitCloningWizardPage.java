...
public class GitCloningWizardPage extends AbstractOpenShiftWizardPage {
	...
	protected IGitCloningPageModel model;
    ...
    public GitCloningWizardPage(IWizard wizard, IGitCloningPageModel model) {
        this(getTitle(model), "Configure the cloning settings by specifying the clone destination", "Cloning settings", wizard, model);
    }

	public GitCloningWizardPage(String title, String description, String pageName, IWizard wizard, IGitCloningPageModel model) {
