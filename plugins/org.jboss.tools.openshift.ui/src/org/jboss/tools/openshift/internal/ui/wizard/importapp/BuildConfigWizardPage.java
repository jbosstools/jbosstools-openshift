...
public class BuildConfigWizardPage extends AbstractOpenShiftWizardPage {
    ...
    protected void doCreateControls(Composite parent, DataBindingContext dbc) {
        ...
        Binding selectedBuildConfigBinding = ValueBindingBuilder.bind(ViewerProperties.singleSelection().observe(buildConfigsViewer))
                .converting(new ObservableTreeItem2ModelConverter()).to(selectedItem).converting(new Model2ObservableTreeItemConverter())
                .in(dbc);
        ...
        DataBindingUtils.addDisposableValueChangeListener(onConnectionChanged(buildConfigsViewer, model), connectionObservable,
                buildConfigsViewer.getTree());
