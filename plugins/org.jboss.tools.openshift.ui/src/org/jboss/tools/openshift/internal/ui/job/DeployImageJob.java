...
public class DeployImageJob extends AbstractDelegatingMonitorJob implements IResourcesModel, ICommonAttributes {
    ...
    protected boolean updateTriggerIfUpdate(Connection connection, String project, String name) {
        try {
            ...
            if (trigger == null || !ResourceKind.IMAGE_STREAM_TAG.equals(trigger.getKind()) || StringUtils.isBlank(trigger.getNamespace())
    ...
    protected void addToGeneratedResources(Map<String, IResource> resources, final Connection connection, final String name,
    ...
    private IImageStream findImageStreamFor(String namespace, DockerImageURI uri) {
        ...
        try {
            ...
            return streams.stream()
                    .filter(is -> is.getDockerImageRepository() != null
