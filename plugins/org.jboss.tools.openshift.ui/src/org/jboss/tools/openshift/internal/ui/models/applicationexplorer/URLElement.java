 ...
 *
 */
public class URLElement extends AbstractOpenshiftUIElement<URL, ComponentElement, ApplicationExplorerUIModel> {
	
	public URLElement(URL url, ComponentElement parentElement) {
		super(parentElement, url);
	}
