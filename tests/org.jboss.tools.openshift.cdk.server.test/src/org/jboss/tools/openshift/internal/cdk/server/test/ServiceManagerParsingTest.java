...
import org.jboss.tools.openshift.internal.cdk.server.core.listeners.ServiceManagerUtility;
...
public class ServiceManagerParsingTest extends TestCase {
	...
	private String[] serviceManager101Linux() {
		return new String[] { "Configured services:", "docker - running", "openshift - running", "kubernetes - stopped",
				"", "docker env:", "# Set the following environment variables to enable access to the",
				...
				"export DOCKER_TLS_VERIFY=1", "export DOCKER_API_VERSION=1.21",
	...
	private String[] serviceManager101Win() {
		return new String[] { "Configured services:", "docker - running", "openshift - running", "kubernetes - stopped",
				...
				"setx DOCKER_TLS_VERIFY 1", "setx DOCKER_API_VERSION 1.21",
				"# run following command to configure your shell:",
				"# eval # Set the following environment variables to enable access to the # docker daemon running inside of the vagrant virtual machine: export DOCKER_HOST=tcp://10.1.2.2:2376 export DOCKER_CERT_PATH=/home/rob/Downloads/cdk/20160608/cdk/components/rhel/rhel-ose/.vagrant/machines/default/virtualbox/docker export DOCKER_TLS_VERIFY=1 export DOCKER_API_VERSION=1.21 # run following command to configure your shell: # eval \"$(vagrant service-manager env docker)\"",
				"", "openshift env:", "You can access the OpenShift console on: https://10.1.2.2:8443/console",
				"To use OpenShift CLI, run: oc login https://10.1.2.2:8443", "", };
	...
	private String[] serviceManager102Win() {
		return new String[] { "", "# docker env:", "# Set the following environment variables to enable access to the",
				...
				"# You can access the OpenShift console on: https://10.1.2.2:8443/console",
				"# To use OpenShift CLI, run: oc login https://10.1.2.2:8443",
				"setx OPENSHIFT_URL https://10.1.2.2:8443", "setx OPENSHIFT_WEB_CONSOLE https://10.1.2.2:8443/console",
				"", "# run following command to configure your shell:", "# eval \"$(vagrant service-manager env)\"", };
	}
	...
	private String[] serviceManagerWinSET() {
		return new String[] { "# docker env:", "# Set the following environment variables to enable access to the",
				...
				"# You can access the OpenShift console on: https://10.1.2.2:8443/console",
				"# To use OpenShift CLI, run: oc login https://10.1.2.2:8443",
				"SET OPENSHIFT_URL=https://10.1.2.2:8443", "SET OPENSHIFT_WEB_CONSOLE=https://10.1.2.2:8443/console",
