...
import org.jboss.tools.openshift.express.test.core.connection.ExpressConnectionPersistencyTest;
...
@RunWith(Suite.class)
@SuiteClasses({ ActionFilterAdapterFactoryTest.class, ApplicationDetailsContentProviderTest.class, ApplicationPropertySourceTest.class,
        OpenShiftMavenProfileTests.class, EmbedCartridgeStrategyTest.class, ExpressExplorerContentProviderTest.class,
        LazyCredentialsPrompterTest.class, LazySSLCertificateCallbackTest.class, SSHUserConfigTest.class,
        ExpressConnectionsRegistryTest.class, ExpressConnectionTest.class, ExpressConnectionPersistencyTest.class,
        OpenShiftMarkerTest.class, SimplePropertyActionFilterTest.class, StringsPreferenceValueTest.class })
/**
