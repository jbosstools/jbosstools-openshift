...
public class NoopDomainFake implements IDomain {
    ...
    @Override
    public IApplication createApplication(String arg0, IStandaloneCartridge arg1, ApplicationScale arg2, IGearProfile arg3, String arg4,
            int arg5, Map<String, String> arg6, IEmbeddableCartridge... arg7) throws OpenShiftException {
        throw new UnsupportedOperationException();
    }

    @Override
    public IApplication createApplication(String name, ApplicationScale scale, IGearProfile gearProfile, String initialGitUrl, int timeout,
            Map<String, String> environmentVariable, ICartridge... cartridges) throws OpenShiftException {
        throw new UnsupportedOperationException();
    }
