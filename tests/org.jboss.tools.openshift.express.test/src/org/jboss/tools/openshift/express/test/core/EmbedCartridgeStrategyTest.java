...
public class EmbedCartridgeStrategyTest {
    ...
    protected void createEmbeddableCartridgeStrategy(ICartridge... cartridges) {
        List<ICartridge> allEmbeddableCartridgeList = createCartridgesList(CARTRIDGE_MYSQL, CARTRIDGE_PHPMYADMIN, CARTRIDGE_POSTGRESQL,
                CARTRIDGE_ROCKMONGO, CARTRIDGE_MONGODB, CARTRIDGE_JENKINS_CLIENT, CARTRIDGE_10GEN_MMS_AGENT);
