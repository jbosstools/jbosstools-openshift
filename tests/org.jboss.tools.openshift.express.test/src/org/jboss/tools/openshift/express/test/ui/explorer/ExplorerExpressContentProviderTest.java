...
import org.jboss.tools.openshift.express.internal.ui.explorer.ExplorerExpressContentProvider;
...
public class ExplorerExpressContentProviderTest {

	private ExplorerExpressContentProvider provider;
	private ConnectionsRegistry registry;
	@Mock private IApplication application;
	@Mock private IDomain domain;
	@Mock private IConnection connection;

	@Before
	public void setup(){
		provider = new ExplorerExpressContentProvider();
