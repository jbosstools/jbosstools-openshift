...
public class JobChainBuilderTest {
    ...
    private void createJobs(final int numOfJobs, ISchedulingCondition[] conditions, IStatus[] doneStatus, JobChainBuilder builder,
            JobCounter counter) {
        if (conditions == null) {
            conditions = new ISchedulingCondition[] { new JobChainBuilder.NullCondition(), new JobChainBuilder.NullCondition(),
