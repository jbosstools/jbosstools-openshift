...
public class ConnectionsFactoryTest {
    ...
    public void addShouldAddAFactory() {
        ...
        // operation
        ((ConnectionsFactory)connectionsFactory)
                .addConnectionFactory(createConnectionFactory(A_CONNECTION_FACTORY_ID, AConnection.class, "http://localhost"));
    ...
    public void getAllShouldReturnFactoriesForGivenConnectionClass() {
        ...
        ((ConnectionsFactory)connectionsFactory).addConnectionFactory(createConnectionFactory(
                createConnectionFactoryId(DifferentConnection.class), DifferentConnection.class, OTHER_CONNECTION_SERVER));
