...
public class CreateApplicationFromImageJobTest {
    ...
    @Mock
    private IBuildConfigPageModel bcModel;
    @Mock
    private IDeployImageParameters deployImageModel;
    @Mock
    ...
    @Mock
    private IBuildConfigBuilder.IGitSourceBuilder sourceBuilder;
    @Mock
    private IBuildConfigBuilder.ISourceStrategyBuilder sourceStratBuilder;
    @Mock
    ...
    static class TestCreateApplicationFromImageJob extends CreateApplicationFromImageJob {
        ...
        @Override
        public void addToGeneratedResources(Map<String, IResource> resources, final Connection connection, final String name,
