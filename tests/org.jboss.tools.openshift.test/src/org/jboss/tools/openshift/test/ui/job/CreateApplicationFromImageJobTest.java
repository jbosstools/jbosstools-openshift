...
public class CreateApplicationFromImageJobTest {
	...
	static class TestCreateApplicationFromImageJob extends CreateApplicationFromImageJob {
		...
		public TestCreateApplicationFromImageJob(IBuildConfigPageModel buildConfigModel,
				IDeployImageParameters deployImageModel) {
			super(buildConfigModel, deployImageModel);
		}

		@Override
		public void addToGeneratedResources(Map<String, IResource> resources, final Connection connection,
