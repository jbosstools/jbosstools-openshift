...
public class ApplicationSourceFromTemplateModelTest {
	...
	public void should_return_first_parameter_as_selected_parameter_when_new_parameters_are_set() {
		...
		List<IParameter> parameters = Arrays.asList(mockParameter("n1", "v1"), mockParameter("n2", "v2"),
				mockParameter("n3", "v3"));
		// when
	...
	public void should_reset_selected_parameter_to_first_parameter_as_selected_parameter_when_new_parameters_are_set() {
		...
		// when
		model.setParameters(
				Arrays.asList(mockParameter("n10", "v10"), mockParameter("n20", "v20"), mockParameter("n30", "v30")));
		// then
		assertThat(model.getSelectedParameter()).isNotNull();
	...
	private void whenTemplateIsSelected(ITemplate template) {
		model.propertyChange(new PropertyChangeEvent(this, IApplicationSourceListPageModel.PROPERTY_SELECTED_APP_SOURCE,
				null, new TemplateApplicationSource(template)));
	}
