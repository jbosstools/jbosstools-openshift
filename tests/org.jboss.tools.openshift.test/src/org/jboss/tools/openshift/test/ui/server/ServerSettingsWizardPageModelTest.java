...
public class ServerSettingsWizardPageModelTest {
    ...
    public void setUp() throws CoreException {
        ...
        this.model = createModel(ResourceMocks.PROJECT2_SERVICES[1], null, null, Arrays.asList(project1, project2, project3, project4),
                connection, server);
    }
    ...
    public void shouldReturnServiceMatchingGitRemoteOfProjectModelWasInitializedWith() {
        ...
        ServerSettingsWizardPageModel model = createModel(null, null, project2, Arrays.asList(project1, project2, project3, project4),
                connection);
        // when
    ...
    public void shouldReturn1stServiceIfNoServiceMatchesGitRemoteOfProjectModelWasInitializedWith() {
        // given
        ServerSettingsWizardPageModel model = createModel(null, null, project1, Arrays.asList(project1, project2, project3, project4),
                connection);
        // when
        IResource resource = model.getResource();
        // then
    ...
    public void shouldUpdateSourcePathIfNewDeployProjectIsSet() {
        // given
        assertThat(model.getSourcePath()).isEqualTo(VariablesHelper.addWorkspacePrefix(project2.getFullPath().toString()));
        //when
        model.setDeployProject(project4);
        // then
        assertThat(model.getSourcePath()).isEqualTo(VariablesHelper.addWorkspacePrefix(project4.getFullPath().toString()));
    }
    ...
    public void should_return_valid_route_if_initialized_with_invalid_route() {
        // given
        ServerSettingsWizardPageModel model = createModel(ResourceMocks.PROJECT2_SERVICES[1], ResourceMocks.PROJECT3_ROUTES[0], null,
                Arrays.asList(project1, project3, project4), connection);
        // when
    ...
    public void should_set_server_connection_when_updating_server()
        ...
        verify(model, atLeastOnce()).updateServer(eq(connectionURL), any(com.openshift.restclient.model.IResource.class), anyString(),
    ...
    public void should_set_server_deployProject_when_updating_server() throws CoreException {
        ...
        verify(model, atLeastOnce()).updateServer(anyString(), any(IService.class), anyString(), anyString(), anyString(), anyString(),
                anyString(), anyString(), eq(deployProject));
    }
    ...
    public void should_set_server_sourcePath_when_updating_server() throws CoreException {
        ...
        verify(model, atLeastOnce()).updateServer(anyString(), any(IService.class), eq(sourcePath), anyString(), anyString(), anyString(),
    ...
    public void should_set_server_podPath_when_updating_server() throws CoreException {
        ...
        verify(model, atLeastOnce()).updateServer(anyString(), any(IService.class), anyString(), anyString(), eq(podPath), anyString(),
                anyString(), anyString(), any(org.eclipse.core.resources.IProject.class));
    }
    ...
    public void should_set_server_podPath_to_empty_string_when_updating_server_if_set_to_infer_it() throws CoreException {
        ...
        verify(model, atLeastOnce()).updateServer(anyString(), any(IService.class), anyString(), anyString(), eq(""), anyString(),
                anyString(), anyString(), any(org.eclipse.core.resources.IProject.class));
    }
    ...
    public void should_set_server_service_when_updating_server() throws CoreException {
        ...
        verify(model, atLeastOnce()).updateServer(anyString(), eq(resource), anyString(), anyString(), anyString(), anyString(),
                anyString(), anyString(), any(org.eclipse.core.resources.IProject.class));
    }
    ...
    public void should_set_server_route_when_updating_server() throws CoreException {
        ...
        verify(model, atLeastOnce()).updateServer(anyString(), any(IService.class), anyString(), eq(routeURL), anyString(), anyString(),
                anyString(), anyString(), any(org.eclipse.core.resources.IProject.class));
    }
    ...
    public void should_not_set_route_if_setSelecteDefaultRoute_is_false_when_updating_server() throws CoreException {
        ...
        verify(model, atLeastOnce()).updateServer(anyString(), any(IService.class), anyString(), anyString(), anyString(), anyString(),
                anyString(), isNull(String.class), any(org.eclipse.core.resources.IProject.class));
    }
