...
public class ConnectionWrapperTest {
    ...
    public void prepareData() throws Exception {
        ...
        this.watchListener = new WatchListenerTestable(watchManager, project, connection, ResourceKind.BUILD_CONFIG, 0, 0);
    ...
    private static class WatchListenerTestable extends WatchListener {
        ...
        protected WatchListenerTestable(WatchManager watchManager, IProject project, IOpenShiftConnection conn, String kind, int backoff,
                long lastConnect) {
