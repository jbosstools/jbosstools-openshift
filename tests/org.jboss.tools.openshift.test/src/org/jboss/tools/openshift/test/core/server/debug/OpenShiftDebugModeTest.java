...
public class OpenShiftDebugModeTest {
    ...
    public void setUp() throws CoreException, UnsupportedEncodingException, MalformedURLException {
        ...
        this.dc = createDeploymentConfig("someDc", createProject("someProject"),
                // no env var
                null,
                // no containers
                null, connection);
    ...
    public void shouldSendUpdatedDebugGivenUserEnablesDebugAndDebugEnvVarIsEnabledWithDifferentPort()
        ...
        mockGetEnvironmentVariables(
                asList(createEnvironmentVariable(KEY_DEVMODE, Boolean.TRUE.toString()), createEnvironmentVariable(KEY_DEBUGPORT, "84")),
                dc);
        // when
        context.setDebugEnabled(true);
        debugMode.execute(new NullProgressMonitor());
    ...
    public void shouldDisableDebugAndSendGivenUserDisablesDebugAndDebugEnvVarIsEnabledButOnDifferentPort()
        ...
        // given
        mockGetEnvironmentVariables(
                asList(createEnvironmentVariable(KEY_DEVMODE, Boolean.TRUE.toString()), createEnvironmentVariable(KEY_DEBUGPORT, "99")),
                dc);
        // when
        context.setDebugEnabled(false);
        debugMode.execute(new NullProgressMonitor());
    ...
    public void shouldReplaceDebugPortGivenExistingPortDiffersFromRequestedPort()
        ...
        // given
        mockGetEnvironmentVariables(
                asList(createEnvironmentVariable(KEY_DEVMODE, Boolean.FALSE.toString()), createEnvironmentVariable(KEY_DEBUGPORT, "88")),
                dc);
    ...
    public class TestableDebugMode extends OpenShiftDebugMode {
        ...
        @Override
        public void sendUpdated(IDeploymentConfig dc, DebugContext context, IProgressMonitor monitor) throws CoreException {
        }
    }
