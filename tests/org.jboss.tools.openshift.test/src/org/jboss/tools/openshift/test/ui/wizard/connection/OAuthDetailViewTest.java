...
public class OAuthDetailViewTest {
    ...
    public void testThatPageWithTokenDoesMatch() {
        TokenExtractor extractor = new TokenExtractor(
                "" + "<style>" + "    body     { font-family: sans-serif; font-size: 14px; margin: 2em 2%; background-color: #F9F9F9; }"
                        ...
                        + "    a        { color: #00f; text-decoration: none; }" + "    a:hover  { text-decoration: underline; }"
                        + "    @media (min-width: 768px) {" + "        .nowrap { white-space: nowrap; }" + "    }" + "</style>"
                        + "  <h2>Your API token is</h2>" + "  <code>mytoken</code>" +
